...
public class Member {
	...
	public Member(int memberIdx, String email, String password, String petNumber, String name, String profile,
			Date birthday, int sex, String address, int breedIdx, int neutering, String snsId, int snsType,
			String regDate, String outDate, int exist) {
	...
	public String toString() {
		return "Member [memberIdx=" + memberIdx + ", email=" + email + ", password=" + password + ", petNumber="
				+ petNumber + ", name=" + name + ", profile=" + profile + ", birthday=" + birthday + ", sex=" + sex
				+ ", address=" + address + ", breedIdx=" + breedIdx + ", neutering=" + neutering + ", snsId=" + snsId
				+ ", snsType=" + snsType + ", regDate=" + regDate + ", exist=" + exist + "]";
	};
